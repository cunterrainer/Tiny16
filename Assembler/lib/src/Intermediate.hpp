...
static const std::unordered_map<OpcodeIR, std::uint16_t> s_InstructionIRSizeMap = {
    ...
    { OpcodeIR::JE_REG           , 2 },
    { OpcodeIR::JE_LABEL         , 3 },
    { OpcodeIR::JNE_LABEL        , 3 },
    { OpcodeIR::JG_LABEL         , 3 },
    { OpcodeIR::JGE_LABEL        , 3 },
    { OpcodeIR::JL_LABEL         , 3 },
    { OpcodeIR::JLE_LABEL        , 3 },
    { OpcodeIR::JA_LABEL         , 3 },
    { OpcodeIR::JAE_LABEL        , 3 },
    { OpcodeIR::JB_LABEL         , 3 },
    { OpcodeIR::JBE_LABEL        , 3 },
    { OpcodeIR::HALT             , 1 },
    { OpcodeIR::BRK              , 1 },
...
static const std::unordered_map<Opcode, OpcodeIRMapping> s_OpcodeIRMapping = {
    ...
    { Opcode::JNE,    {0, OpcodeIR::JNE_LABEL,          OpcodeIR::JNE_LABEL       }},
    { Opcode::JG ,    {0, OpcodeIR::JG_LABEL ,          OpcodeIR::JG_LABEL        }},
    { Opcode::JGE,    {0, OpcodeIR::JGE_LABEL,          OpcodeIR::JGE_LABEL       }},
    { Opcode::JL ,    {0, OpcodeIR::JL_LABEL ,          OpcodeIR::JL_LABEL        }},
    { Opcode::JLE,    {0, OpcodeIR::JLE_LABEL,          OpcodeIR::JLE_LABEL       }},
    { Opcode::JA ,    {0, OpcodeIR::JA_LABEL ,          OpcodeIR::JA_LABEL        }},
    { Opcode::JAE,    {0, OpcodeIR::JAE_LABEL,          OpcodeIR::JAE_LABEL       }},
    { Opcode::JB ,    {0, OpcodeIR::JB_LABEL ,          OpcodeIR::JB_LABEL        }},
    { Opcode::JBE,    {0, OpcodeIR::JBE_LABEL,          OpcodeIR::JBE_LABEL       }},
