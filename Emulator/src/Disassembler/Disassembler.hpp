...
private:
    ...
    const std::unordered_map<OpcodeMC, std::string_view> m_OpcodeToStringMap = {
        ...
        { OpcodeMC::MUL_IMM_TO_REG  , "MUL"  },
        { OpcodeMC::IMUL_IMM_TO_REG , "IMUL" },
        { OpcodeMC::DIV_IMM_TO_REG  , "DIV"  },
        { OpcodeMC::IDIV_IMM_TO_REG , "IDIV" },
        { OpcodeMC::CMP_IMM_TO_REG  , "CMP"  },
        { OpcodeMC::MOV_REG_TO_REG  , "MOV"  },
        { OpcodeMC::ADD_REG_TO_REG  , "ADD"  },
        { OpcodeMC::SUB_REG_TO_REG  , "SUB"  },
        { OpcodeMC::MUL_REG_TO_REG  , "MUL"  },
        { OpcodeMC::IMUL_REG_TO_REG , "IMUL" },
        { OpcodeMC::DIV_REG_TO_REG  , "DIV"  },
        { OpcodeMC::IDIV_REG_TO_REG , "IDIV" },
        { OpcodeMC::CMP_REG_TO_REG  , "CMP"  },
        { OpcodeMC::JMP_REG         , "JMP"  },
        { OpcodeMC::JMP_LABEL       , "JMP"  },
        { OpcodeMC::JE_REG          , "JE "  },
        { OpcodeMC::JE_LABEL        , "JE "  },
        { OpcodeMC::JNE_LABEL       , "JNE"  },
        { OpcodeMC::JG_LABEL        , "JG "  },
        { OpcodeMC::JGE_LABEL       , "JGE"  },
        { OpcodeMC::JL_LABEL        , "JL "  },
        { OpcodeMC::JLE_LABEL       , "JLE"  },
        { OpcodeMC::JA_LABEL        , "JA "  },
        { OpcodeMC::JAE_LABEL       , "JAE"  },
        { OpcodeMC::JB_LABEL        , "JB "  },
        { OpcodeMC::JBE_LABEL       , "JBE"  },
        { OpcodeMC::BRK             , "BRK " },
        { OpcodeMC::HALT            , "HALT" },
        { OpcodeMC::NOP             , "NOP " },
