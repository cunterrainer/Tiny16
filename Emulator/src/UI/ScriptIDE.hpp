    ...
    private:
        TextEditor::LanguageDefinition GetLanguageDefinition() const
        {
            ...
            constexpr const char* const keywords[] = {
                "mov", "add", "sub", "mul", "imul", "div", "idiv", "jmp", "je", "jne", "jl", "jle", "jg", "jge", "ja", "jae", "jb", "jbe", "cmp", "brk", "halt", "load", "store", "loadb", "storeb", "extbh", "extbl", "insbh", "insbl", "swapb", "and", "or", "xor", "neg", "nop",
                "MOV", "ADD", "SUB", "MUL", "IMUL", "DIV", "IDIV", "JMP", "JE", "JNE", "JL", "JLE", "JG", "JGE", "JA", "JAE", "JB", "JBE", "CMP", "BRK", "HALT", "LOAD", "STORE", "LOADB", "STOREB", "EXTBH", "EXTBL", "INSBH", "INSBL", "SWAPB", "AND", "OR", "XOR", "NEG", "NOP"
            };
